...
System.register([], function (_export, _context) {
    ...
    return {
        ...
        execute: function () {
            ...
            window.ace.define('ace/snippets', ['require', 'exports', 'module', 'ace/lib/oop', 'ace/lib/event_emitter', 'ace/lib/lang', 'ace/range', 'ace/anchor', 'ace/keyboard/hash_handler', 'ace/tokenizer', 'ace/lib/dom', 'ace/editor'], function (require, exports, module) {
                'use strict';
                ...
                (function () {
                    ...
                    this.insertSnippetForSelection = function (editor, snippetText) {
                        ...
                        for (var i = 0; i < tokens.length; i++) {
                            ...
                            arg.push(p);
                            expanding[id] = p;
                            (_tokens = tokens).splice.apply(_tokens, _toConsumableArray(arg));
                    ...
                    this.getActiveScopes = function (editor) {
                        ...
                        if (snippetMap[scope] && snippetMap[scope].includeScopes) {
                            scopes.push.apply(scopes, _toConsumableArray(snippetMap[scope].includeScopes));
                        }
                        scopes.push('_');
                        return scopes;
                    };
            ...
            define('ace/ext/language_tools', ['require', 'exports', 'module', 'ace/snippets', 'ace/autocomplete', 'ace/config', 'ace/lib/lang', 'ace/autocomplete/util', 'ace/autocomplete/text_completer', 'ace/editor', 'ace/config'], function (require, exports, module) {
                ...
                exports.setCompleters = function (val) {
                    completers.length = 0;
                    if (val) completers.push.apply(completers, _toConsumableArray(val));
                };
